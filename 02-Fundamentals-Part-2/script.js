...
// for (let exacis = 1; exacis <= 4; exacis++) {
//   console.log(`-------- Starting exercise ${exacis}`);

//   for (let rep = 1; rep <= 6; rep++) {
//     console.log(`Exercise ${exacis}: Lifting weight repetition ${rep} 🏋️‍♀️`);
//   }
// }
///////////////////////////////////////
// The while Loop
...
//   // totals[i] = calTip(bills[i]) + bills[i];
//   const trick = calTip(bills[i]);
//   tips.push(trick);
//   totals[i] = trick + bills[i];
// }
